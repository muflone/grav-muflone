...
taxonomy:
    tag:
        ...
        - synaptics
        - touchpad
summary: 'Installare Arch Linux su Lenovo IdeaPad G50-70 con UEFI e Secure Boot (parte 13 - Installare l''ambiente grafico)'
product: articles
depth: 2
---
...
[driver Intel]: https://wiki.archlinux.org/index.php/Intel_graphics "Intel graphics"
[Synaptics]: https://wiki.archlinux.org/index.php/Touchpad_Synaptics "Touchpad Synaptics"
